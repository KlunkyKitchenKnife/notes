PHI, according to the [electronic Code of Federal Regulations](https://www.ecfr.gov/current/title-45/subtitle-A/subchapter-C/part-160/subpart-A/section-160.103), is defined as "individually identifiable health information" that is:
- transmitted by electronic media;
- maintained in electronic media; or
- transmitted or maintained in any other form or medium.

There are also exceptions from the definition provided, such as those from education records which are regulated under FERPA, employment records which are regulated under employment and anti discrimination laws, and those who have been dead for more than 50 years.

Further, ["individually identifiable health information"](https://www.hhs.gov/hipaa/for-professionals/privacy/laws-regulations/index.html) is information, including demographic data, that relates to:
